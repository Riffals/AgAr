...
<body>
    <div class="container">
        <div class="top-section">
            <h1 class="welcome-text">Create<br>an Account</h1>
        </div>
            ...
            <div class="input-container">
                ...
                <div class="sign-in-container">
                    ...
                    <button class="arrow-button" href="/login">
                        <img src="<?php echo e(asset('storage/arrow-right (1).png')); ?>" alt="img" style="width: 50px; height: 50px;" class="loading-page">
...
</html><?php /**PATH C:\xampp\htdocs\AgAr_Indobot\resources\views/register.blade.php ENDPATH**/ ?>